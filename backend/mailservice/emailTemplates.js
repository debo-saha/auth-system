          ...
          <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
            ...
            <tr>
              <td style="padding: 20px; color: #333333; font-size: 16px;">
                ...
                <p style="margin: 0 0 15px;">
                  You can now access your dashboard, explore our services, and get started.
                </p>
                <p style="margin: 0 0 20px;">
                  If you have any questions or need help, feel free to reply to this email.
                </p>
                <p style="margin: 0 0 10px;">Cheers,</p>
                <p style="margin: 0 0 10px;"><strong>The [Your Company Name] Team</strong></p>
              </td>
            </tr>
            <tr>
              <td style="background-color: #eeeeee; padding: 15px; text-align: center; font-size: 12px; color: #666666;">
                ...
                <a href="https://yourcompany.com" style="color: #4CAF50; text-decoration: none;">Visit our website</a>
              </td>
            </tr>
          </table>
        </td>
